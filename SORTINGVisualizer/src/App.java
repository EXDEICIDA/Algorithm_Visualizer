...
public class App extends JFrame implements ActionListener {
    ...
    public App(){
        ...
        lblTtl.setFont(new Font("Niagara Solid", Font.BOLD, 35));
        lblTtl.setForeground(Color.white);
        panelUpper.add(lblTtl);

        // Add Name
        name = new JLabel("Dev. by: Javad Soltanov");
        name.setBounds(327,50,206,40);
        name.setFont(new Font("Niagara Solid", Font.BOLD, 25));
        ...
        runtimeLabel.setFont(new Font("Niagara Solid", Font.BOLD, 25));
        ...
        comparisonsLabel.setFont(new Font("Niagara Solid", Font.BOLD, 25));
        ...
        arrayAccessesLabel.setFont(new Font("Niagara Solid", Font.BOLD, 25));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource()==algosDropdown) {
            ...
            if (algosDropdown.getSelectedItem().equals("Merge Sort")) {
                selectedAlgo = "Merge";
